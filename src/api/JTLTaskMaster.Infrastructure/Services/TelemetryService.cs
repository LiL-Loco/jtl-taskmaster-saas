...
public class TelemetryService : ITelemetryService
{
    ...
    public IDisposable StartOperation(string name, string? context = null)
    {
        ...
        return new OperationScope(name, _logger);
    }
}
...
internal class OperationScope : IDisposable
{
    ...
    public OperationScope(string operationName, ILogger logger)
    {
        ...
        _logger.LogInformation("Starting operation: {Operation}", _operationName);
    }

    public void Dispose()
    {
        _stopwatch.Stop();
        _logger.LogInformation("Completed operation: {Operation}, Duration: {Duration}ms",
